...
def extract_spatial_features(
    ...
    """
    Computes spatial features from a binary mask (thyroid).
    ...
    if aspect_ratio < 1.0:
        aspect_ratio_interpretation = "taller-than-wide (suspicious per TI-RADS)"
...
def get_location_quadrant(
    ...
    The breast branch exists here for organs dict completeness; the
    laterality handling matches us_breast/postprocess.py exactly.
    """
    H, W = image_size
    cx, cy = centroid
